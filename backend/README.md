...
## Project Structure
    ...
    ├── testapiautosetting_127045  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127045`
...
2. Clone this repo and `cd testapiautosetting_127045`
